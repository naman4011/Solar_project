...
plt.title('longitude VS MonthAvgI_HP(Aprilh)')
...
plt.title('longitude VS YearAvgI_IncP(April)')
plt.xlabel('Longitude')
...
plt.title('longitude VS OptSlopeAngle(April)')
plt.xlabel('Longitude')
...
plt.title('longitude VS YearAvgI_B(April)')
plt.xlabel('Longitude')
...
plt.title('longitude VS Ratio_D_G(April)')
plt.xlabel('Longitude')

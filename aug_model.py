...
plt.title('longitude VS MonthAvgI_HP(August)')
...
plt.title('longitude VS YearAvgI_IncP(August)')
plt.xlabel('Longitude')
...
plt.title('longitude VS OptSlopeAngle(August)')
plt.xlabel('Longitude')
...
plt.title('longitude VS YearAvgI_B(August)')
plt.xlabel('Longitude')
...
plt.title('longitude VS Ratio_D_G(August)')
plt.xlabel('Longitude')

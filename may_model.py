...
plt.title('longitude VS MonthAvgI_HP(May)')
...
plt.title('longitude VS YearAvgI_IncP(May)')
plt.xlabel('Longitude')
...
plt.title('longitude VS OptSlopeAngle(May)')
plt.xlabel('Longitude')
...
plt.title('longitude VS YearAvgI_B(May)')
plt.xlabel('Longitude')
...
plt.title('longitude VS Ratio_D_G(May)')
plt.xlabel('Longitude')

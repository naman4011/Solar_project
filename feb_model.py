...
plt.title('longitude VS MonthAvgI_HP(Feb)')
...
plt.title('longitude VS YearAvgI_IncP(Feb)')
plt.xlabel('Longitude')
...
plt.title('longitude VS OptSlopeAngle(Feb)')
plt.xlabel('Longitude')
...
plt.title('longitude VS YearAvgI_B(Feb)')
plt.xlabel('Longitude')
...
plt.title('longitude VS Ratio_D_G(Feb)')
plt.xlabel('Longitude')

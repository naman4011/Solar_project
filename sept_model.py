...
plt.title('longitude VS MonthAvgI_HP(September)')
...
plt.title('longitude VS YearAvgI_IncP(September)')
plt.xlabel('Longitude')
...
plt.title('longitude VS OptSlopeAngle(September)')
plt.xlabel('Longitude')
...
plt.title('longitude VS YearAvgI_B(September)')
plt.xlabel('Longitude')
...
plt.title('longitude VS Ratio_D_G(September)')
plt.xlabel('Longitude')

...
plt.title('longitude VS MonthAvgI_HP(jan)')
...
plt.title('longitude VS YearAvgI_IncP(jan)')
plt.xlabel('Longitude')
...
plt.title('longitude VS OptSlopeAngle(jan)')
plt.xlabel('Longitude')
...
plt.title('longitude VS YearAvgI_B(jan)')
plt.xlabel('Longitude')
...
plt.title('longitude VS Ratio_D_G(jan)')
plt.xlabel('Longitude')

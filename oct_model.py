...
plt.title('longitude VS MonthAvgI_HP(October)')
...
plt.title('longitude VS YearAvgI_IncP(October)')
plt.xlabel('Longitude')
...
plt.title('longitude VS OptSlopeAngle(October)')
plt.xlabel('Longitude')
...
plt.title('longitude VS YearAvgI_B(October)')
plt.xlabel('Longitude')
...
plt.title('longitude VS Ratio_D_G(October)')
plt.xlabel('Longitude')

...
plt.title('longitude VS MonthAvgI_HP(November)')
...
plt.title('longitude VS YearAvgI_IncP(November)')
plt.xlabel('Longitude')
...
plt.title('longitude VS OptSlopeAngle(November)')
plt.xlabel('Longitude')
...
plt.title('longitude VS YearAvgI_B(November)')
plt.xlabel('Longitude')
...
plt.title('longitude VS Ratio_D_G(November)')
plt.xlabel('Longitude')

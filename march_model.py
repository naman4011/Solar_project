...
plt.title('longitude VS MonthAvgI_HP(March)')
...
plt.title('longitude VS YearAvgI_IncP(March)')
plt.xlabel('Longitude')
...
plt.title('longitude VS OptSlopeAngle(March)')
plt.xlabel('Longitude')
...
plt.title('longitude VS YearAvgI_B(March)')
plt.xlabel('Longitude')
...
plt.title('longitude VS Ratio_D_G(March)')
plt.xlabel('Longitude')

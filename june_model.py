...
plt.title('longitude VS MonthAvgI_HP(June)')
...
plt.title('longitude VS YearAvgI_IncP(June)')
plt.xlabel('Longitude')
...
plt.title('longitude VS OptSlopeAngle(June)')
plt.xlabel('Longitude')
...
plt.title('longitude VS YearAvgI_B(June)')
plt.xlabel('Longitude')
...
plt.title('longitude VS Ratio_D_G(June)')
plt.xlabel('Longitude')
